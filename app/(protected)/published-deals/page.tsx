...
import GetDeals, { GetAllDeals } from "@/app/actions/get-screened-deal";
...
export const metadata: Metadata = {
  title: "Screened Deals",
  description: "View the deals that have been screened",
};
...
const RawDealsPage = async (props: { searchParams: SearchParams }) => {
  ...
  return (
    ...
    Browse through our collection of processed deals gathered from
